...
namespace RVO
{
    ...
    internal class KdTree
    {
        ...
        {
            var simulatorAgents = Simulator.Instance.agents_;
            var arrayLen = simulatorAgents.Count;
            var n = Simulator.Instance.agentCount_;
            if (agents_ == null || agents_.Length != n)
            {
                agents_ = new Agent[n];
                ...
                {
                    if (simulatorAgents[i] != null)
                    {
                        agents_[k++] = simulatorAgents[i];
                    }
                }
